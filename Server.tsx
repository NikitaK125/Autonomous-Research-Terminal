...
- Keep your answers clean, well-formatted in markdown, and concise (under 3 paragraphs).`;
  ...
  // Autonomous Research Terminal Endpoint
  app.post('/api/research', async (req, res) => {
    try {
      ...
      const systemInstruction = `You are "AETHER-OS Autonomous Agent Model 0.9.1", a deep cybernetic research artificial intelligence.
Your task is to synthesize highly technical, structured report summaries for the developer console based on any provided query.
- Use a high-tech terminal, scholarly, yet computer shell style of tone.
- Organize your response using explicit titles/paragraphs like "1. AGENT HEURISTICS:" and "2. TARGET REPORT:" and "3. COGNITIVE SYNTHESIS SUMMARY:".
- Keep answers technical, precise, and highly dense. Reference vector mathematics, statistical equations, botanical definitions, or history depending on what was asked.
- Keep the overall response structured and under 180 words. Do not write conversational fluff.`;
      ...
      res.status(500).json({
        error: 'Terminal cognitive engine index fault',
        details: error.message || error,
      });
    }
  });
